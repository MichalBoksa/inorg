...
const BigCompanyInfo = () => {
  return (
    <section className='mb-4'>
         ...
         <h1 className='text-blue-80 font-semibold text-3xl lg:text-5xl xl:text-4xl 2xl:text-5xl 3xl:text-6xl tracking-widest '>Duże przedsiębiorstwa i grupy kapitałowe</h1>
    </div>
