        ...
        <div className="max-w-screen-lg mx-auto p-5">
            <div className="grid grid-cols-1 md:grid-cols-12 border">
                <div className="bg-gray-900 md:col-span-4 p-10 text-white">
                    ...
                    {DATA?.CONTACT_FORM_BE_WITH_US} <span className="text-indigo-600"> {DATA?.CONTACT_FORM_CONTACT}</span>
                    </h3>
                    <p className="mt-4 leading-7 text-gray-200">
                    {DATA?.CONTACT_FORM_DESC}
                    </p>
                ...
                <form className="md:col-span-8 p-10" onSubmit={handleSubmit(onSubmit)}>
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                ...
                                {...register('name', { required: DATA?.CONTACT_FORM_ERROR_MSG })} ></input>
                            {errors.name && <p className="text-red-500 text-xs italic">{errors.name.message}</p>}
                        </div>
                        <div className="w-full md:w-1/2 px-3">
                            <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                htmlFor="grid-last-name">
                                {DATA?.CONTACT_FORM_SURNAME}
                            </label>
                            <input
                                className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" 
                                {...register('surname', { required:   DATA?.CONTACT_FORM_ERROR_MSG })}/>
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                ...
                                {DATA?.CONTACT_FORM_COMPANY}
                            </label>
                            <input
                                className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-company" type="text"
                                {...register('company', { required:   DATA?.CONTACT_FORM_ERROR_MSG })}/>
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <textarea rows={10}
                                className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                {...register('message', { required:   DATA?.CONTACT_FORM_ERROR_MSG })}></textarea>
