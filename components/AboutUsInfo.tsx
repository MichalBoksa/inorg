  ...
  return (
   <section className='mb-4'>
    ...
    <div className='flex w-full max-h-[350px] justify-center px-20' >
       ...
       <div className='bg-gray-200 rounded-xl flex flex-wrap justify-center xl:gap-24 2xl:gap-32 mt-8 mb-4 px-16 ml-20 mr-20 '>

            <Link href="aboutUs/whoAreWe" className='w-1/5 bg-gray-100 h-60 rounded relative mt-16 '> 
                <h1 className='text-sky-40 text-left font-bold text-2xl lg:text-xl  3xl:text-2xl mt-4 px-6'>{DATA?.WHO_ARE_WE}</h1> 
            ...
            <Link href="aboutUs/code" className="w-1/5 bg-gray-100 h-60 rounded relative mt-16">
              <h1 className='text-sky-40 text-left font-bold text-2xl lg:text-xl 3xl:text-2xl mt-4 px-6'>{DATA?.CODE}</h1> 
            ...
            <Link href="aboutUs/managment" className="w-1/5 bg-gray-100 h-60 rounded relative mt-16">
                <h1 className='text-sky-40 text-left font-bold text-2xl lg:text-xl 3xl:text-2xl mt-4 px-6'>{DATA?.COUNCIL}</h1> 
            ...
            <Link  href="aboutUs/associates" className="w-1/5 bg-gray-100 h-60 mt-16 rounded relative mb-10">
              <h1 className='text-sky-40 text-left font-bold text-3xl lg:text-xl 3xl:text-2xl mt-4 px-6'>{DATA?.ASSOCIATES}</h1> 
            ...
            <Link href="aboutUs/goals" className="w-1/5 bg-gray-100 h-60 mt-16 rounded relative mb-10 ">
              <h1 className='text-sky-40 text-left font-bold text-3xl lg:text-xl 3xl:text-2xl mt-4 px-6'>{DATA?.MISSION}</h1> 
