  ...
  return (
   <section className='mb-4 '>
    <div className="flex justify-left ml-20 mb-10 mt-6" >
         <h1 className='text-blue-80 font-bold text-3xl lg:text-6xl '>Branże</h1>
    </div>
    ...
    <div className='flex w-full max-h-[350px] justify-center px-20' >
       ...
       <div className='bg-gray-200 rounded-xl flex flex-col mt-8 mb-4 px-16 mr-20 ml-20 '>
        ...
        <div className='flex space-x-32 mt-8 mb-4 px-16 justify-center'>
            <Link href="aboutUs/whoAreWe" className='w-1/3 bg-gray-100 h-72 rounded relative mt-10 '> 
            ...
            <Link href="aboutUs/code" className="w-1/3 bg-gray-100 h-72 rounded relative mt-10">
            ...
            <div className='flex  space-x-24 mt-12 mb-4 px-16 justify-center'>
                ...
                <Link  href="aboutUs/whoAreWe" className="w-1/3 bg-gray-100 h-72 mt-10 rounded relative mb-10">
