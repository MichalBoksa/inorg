...
export const NAV_LINKS = [
    { href: '/aboutUs', key: 'aboutUs', label: 'TENTANG KAMI' },
    { href: '/products', key: 'products', label: 'PRODUK' },
    { href: '/goz', key: 'goz ', label: 'GOZ DI LINGKUNGAN ANDA' },
    { href: '/partnership', key: 'partnership ', label: 'KERJASAMA' },
    { href: '/recommendation', key: 'recommendation', label: 'REKOMENDASI' },
    { href: '/contactUs', key: 'contact_us', label: 'KONTAK' },
];

export const PRODUCTS = [
    { href: '/products/goodPracticeExchange', name: 'Area Pertukaran Praktik Baik' },
    { href: '/products/advisoryArea', name: 'Area Konsultasi' },
    { href: '/products/trainingArea', name: 'Area Pelatihan' },
    { href: '/products/gozCybersecurity', name: 'GOZ di TI dan Keamanan Siber' },
];
...
export const TARGET_GROUP_DESC = 'Kami mengkhususkan diri dalam menyediakan layanan untuk usaha kecil dan menengah di industri berikut:';
export const INTERNATIONAL_PARTNERSHIP = 'KEMITRAAN INTERNASIONAL';
export const WHERE_WE_OPERATE = 'DI MANA KAMI BEROPERASI';
export const WHERE_WE_OPERATE_DESC = 'Saat ini kami terutama berfokus pada provinsi Silesia, Małopolska, Świętokrzyskie, Podkarpackie, Mazowieckie, dan Lublin. Apakah organisasi Anda berada di provinsi lain tetapi Anda ingin menggunakan layanan kami? Hubungi kami dan kami akan membahas kemungkinan kerjasama secara individu.';
export const INTERNATIONAL_PARTNERSHIP_DESC = 'Kami bekerja sama dengan entitas di berbagai benua, yang membuka kami dan klien kami pada kegiatan internasional dan promosi solusi inovatif. Saat ini, kami berhubungan erat dengan perusahaan di negara-negara seperti Qatar, Uni Emirat Arab, Arab Saudi, Hong Kong, Indonesia, Singapura, Kanada, Chili, Filipina, Uzbekistan, Ukraina, Mongolia, Kenya, Rwanda, Korea Selatan, Malaysia.';
export const COOPERATION = 'Entitas yang bekerja sama dengan kami';
export const WE_ARE_PART_OF = 'Kami adalah bagian dari';

//MATERI
export const MATERIALS1 = 'MATERI REKOMENDASI';
...
export const EVENTS_LIST = [
    ...
    {
        title: 'Kunjungan Bisnis dan Investasi di Indonesia',
...
export const CHOOSEN_PRODUCTS = [
    {
        ...
        description: 'Audit GOZ adalah titik awal untuk semua kegiatan inovasi lingkungan. Ini memungkinkan untuk menentukan cakupan dan arah perubahan organisasi untuk bekerja lebih efisien dan mencapai tujuan strategis dengan lebih mudah.',
    },
    {
        title: 'PROMOSI ORGANISASI DAN SOLUSI GOZ',
    ...
    },
    {
        ...
        description: 'Organisasi yang menggunakan layanan kami dapat mengandalkan dukungan komprehensif dalam mengimplementasikan model dan solusi GOZ. Kami menawarkan berbagai pelatihan dan beroperasi sebagai kantor dukungan citra lingkungan.',
    },
];
...
export const QUICK_LINKS = 'Tautan Cepat';
export const FOOTER_CONTACT_INFO = {
    title: 'Hubungi Kami',
    links: [
        { label: 'Alamat', value: 'ul. Prymasa S. Wyszyńskiego 11 44-100 Gliwice' },
        { label: 'Email', value: 'inorg@inorg.pl' },
        { label: 'Telepon', value: '32 231-39-54' },
    ],
};

//REPUTASI
export const REPUTE = 'Reputasi Merek dan Kompetensi Institut';
...
export const WHO_ARE_WE_HISTORY_DESC = 'Institut Organisasi INORG Sp. z o.o. didirikan pada tanggal 6 November 1987 (awalnya dengan nama Pabrik Layanan Konsultasi Organisasi dan Iklan "INORG"), sebagai salah satu perusahaan swasta pertama di Gliwice dan perusahaan ke-222 di seluruh Provinsi Silesia. INORG didirikan oleh sekelompok ahli dari Masyarakat Ilmiah Organisasi dan Manajemen, yang strateginya didasarkan pada penggunaan pengetahuan substansial dan pengalaman dalam kegiatan konsultasi untuk perusahaan. Pada periode awal, kegiatan perusahaan terutama berkaitan dengan masalah dalam bidang organisasi, manajemen, iklan, dan ekonomi unit ekonomi. Pada bulan November 1990, nama perusahaan berubah menjadi Institut Organisasi "INORG", yang tetap hingga saat ini.';
export const DYNAMIC_SUR = 'Dalam lingkungan yang berkembang secara dinamis, tugas dan tantangan baru bagi perusahaan Polandia terus muncul...';
export const DYNAMIC_SUR_DESC = 'Selama bertahun-tahun pengembangan dinamis kegiatan INORG, seiring dengan munculnya kebutuhan baru di antara klien kami dan memperoleh pengalaman praktis di berbagai cabang industri, perusahaan mengembangkan sejumlah alat dan model ahli yang berguna dari perspektif beroperasi dalam lingkungan yang bergolak dan tidak stabil. Kami terus mengikuti tren dunia terbaru dalam organisasi dan manajemen, mengamati praktik para pemimpin dunia, dan membangun basis pengetahuan berdasarkan solusi menarik yang diterapkan oleh entitas Polandia dan asing. Kami juga memantau situasi pasar di industri klien kami secara terus-menerus.';
export const EXPERTS = 'Kami adalah tim ahli...';
export const EXPERTS_DESC = 'Tim manajer proyek, ahli, dan analis INORG yang dibangun selama bertahun-tahun menggabungkan pengalaman yang terus berkembang di industri konsultasi dengan pendekatan inovatif, kreatif, dan antusias untuk memecahkan masalah klien kami. Institut ini bekerja sama erat dengan staf akademik dari universitas ekonomi dan teknik Silesia, institut industri, dan spesialis dari perusahaan industri. Kami juga telah membangun jaringan kerjasama yang luas dengan mitra yang melengkapi penawaran kami dengan pengetahuan di bidang hukum, manajemen keuangan, psikologi, TI, penggalangan dana untuk pengembangan bisnis, dan berbagai layanan pelatihan. Kami juga bekerja sama dengan organisasi berpengaruh yang memiliki jangkauan global. Misalnya, melalui Pusat Produktivitas dan Kualitas Amerika, kami memberikan klien kami akses ke basis data indikator dan praktik terbaik terbesar di dunia. Kami juga anggota Kamar Industri Kimia Polandia.';
export const REALIZED_PROJECTS = 'Lebih dari 1500 proyek yang diselesaikan...';
export const REALIZED_PROJECTS_DESC = 'Dengan pengalaman luas yang diperoleh dalam proses restrukturisasi strategis dan organisasi, kami menawarkan klien kami lokakarya unik dan akses ke praktik terbaik dalam memecahkan masalah organisasi.';
export const SPEC_ABOUT_US = [
    '➱ Kelompok modal Polandia dan internasional',
    '➱ Institut penelitian',
    '➱ Unit pemerintah daerah (kantor kota, kabupaten, dan kabupaten)',
    '➱ Perusahaan menengah dan besar di industri kimia, energi, TSL (termasuk transportasi kereta api, jalan, dan air, pengiriman dan logistik), pemanasan, mesin, semen, metalurgi, elektroteknik, pengecoran, pertahanan, industri ringan, layanan komunal, layanan B+R+I (kantor teknik, pusat penelitian dan pengembangan perusahaan) dan banyak lainnya',
];
export const RELATIONS = 'Kami membangun hubungan strategis dan jangka panjang dengan klien kami.';
export const RELATIONS_DESC = 'Kami ingin menarik minat Anda pada penawaran kami dan mengusulkan kerjasama yang bertujuan untuk meningkatkan organisasi Anda, mulai dari menetapkan arah strategis perubahan hingga menerapkan program keunggulan operasional yang terperinci.';

//KODE INFORMASI
export const CODE_INFO = 'Kode etik kami';
export const CODE_RULES_DESC = 'Dalam memberikan layanan, kami secara konstan mengelola kepatuhan solusi organisasi yang dirancang dengan:';
export const CODE_RULES = [
    '➱ Hukum yang berlaku',
    '➱ Peraturan internal Klien (kami menghormati pencapaian organisasional yang ada)',
    '➱ Praktik terbaik industri dan kewajiban kepatuhan lainnya yang diterima oleh Klien',
];

export const CODE_RULES_EMPLOYEES_DESC = 'Karyawan dan rekan kami mematuhi Kode Etik Institut Organisasi INORG Sp. z o.o., yang didasarkan pada prinsip utama berikut:';
export const CODE_RULES_EMPLOYEES = [
    '“Primum Non Nocere” - prinsip dasar kami adalah tidak merugikan pihak manapun selama pekerjaan berlangsung.',
    'Kami bertanggung jawab atas tindakan kami. Kami mengambil proyek yang sesuai dengan kualifikasi yang kami miliki dari pendidikan dan pengalaman.',
    'Kami terus meningkatkan keterampilan profesional kami, berusaha untuk pengembangan pribadi yang berkelanjutan.',
    'Kami mematuhi hukum negara di mana kami melaksanakan proyek kami.',
    'Kami memperlakukan semua anggota tim, kolega, dan rekan kerja dalam proyek dengan adil, tanpa memandang ras, agama, jenis kelamin, preferensi pribadi dan budaya, usia, atau kebangsaan.',
    'Selama memberikan layanan konsultasi, kami memastikan kondisi kerja yang sesuai untuk karyawan.',
    'Kami menilai pekerjaan kami dengan jujur, mendengarkan pendapat lain secara objektif, dan mengakui kontribusi orang lain dengan pantas.',
    'Saat memperluas pasar, kami menerapkan prinsip “fair-play” terhadap Klien dan Pesaing.',
    'Saat melaksanakan proyek konsultasi, kami mewakili Klien kami dengan martabat dalam hal yang dipercayakan kepada kami.',
    'Kami menjaga kerahasiaan informasi tentang urusan komersial Klien, proses teknis, dan organisasi (kecuali jika kewajiban untuk mengungkapkannya ada pada kami berdasarkan hukum), bahkan setelah proyek selesai.',
    'Kami memberi tahu atasan, Klien, organisasi profesional, atau lembaga publik kami tentang keadaan yang dapat menyebabkan konflik kepentingan.',
    'Kami menghindari kegiatan yang dapat dianggap atau menciptakan kesan korupsi dan secara terbuka menyatakan penentangan kami terhadap tindakan semacam itu.',
    'Kami melindungi keselamatan, kesehatan, dan kesejahteraan masyarakat dan secara terbuka menyatakan penentangan kami terhadap pelanggaran nilai-nilai ini.',
    'Kami berusaha untuk menyebarkan pengetahuan tentang tanggung jawab sosial perusahaan dan pembangunan berkelanjutan.',
];

//MANAJEMEN
export const MANAGEMENT = 'Manajemen';
export const BOSS = 'presiden';
export const VICE_BOSS = 'wakil presiden';
export const PROMNY = 'Dr. Eng. Henryk Promny';
export const COUNCIL_HEAD = 'Ketua Dewan Ilmiah-Program';
export const COUNCIL_MAN = 'Dewan Ilmiah-Program';

//REKAN
export const OUR_ASSOCIATES = 'Rekan kami';
export const CONST_ASSOCIATES = 'Di antara mitra tetap kami, yang bekerja sama dengan kami selama pelaksanaan proyek, adalah:';
export const CONST_ASSOCIATES_LIST = [
    '➱ Unit penelitian dan pengembangan (institut, institusi pendidikan tinggi seperti: Universitas Ekonomi Karol Adamiecki di Katowice, Universitas Teknologi Silesia)',
    '➱ Kantor teknik',
    '➱ Perusahaan konsultasi ternama',
    '➱ Kantor akuntansi',
    '➱ Kantor hukum',
    '➱ Perusahaan TI',
];

export const OUR_PARTNERS = 'Rekan tetap kami meliputi ahli independen seperti:';
export const OUR_PARTNERS_LIST = [
    '➱ Psikolog, pelatih, ahli SDM',
    '➱ Staf akademik',
    '➱ Ahli bisnis',
    '➱ Spesialis di industri tempat klien kami beroperasi',
];

//TUJUAN
export const OUR_MISSION = 'Misi dan kompetensi kami';
export const INORG_MISSION = 'Misi Institut Organisasi "INORG"';
export const INORG_MISSION_LIST = [
    '➱ Kami ada untuk membantu klien kami berfungsi lebih efisien dan efektif dengan pengetahuan, keterampilan, dan pengalaman kami, berkontribusi pada kesuksesan pasar mereka.',
    '➱ Kami menggunakan bidang pengetahuan baru dan metode penelitian yang menjadi penggerak kreativitas dan kewirausahaan dalam membangun kekuatan dan ekspansi pasar klien kami.',
    '➱ Produk yang kami tawarkan ditandai dengan kualitas tinggi, yang diwujudkan dalam tingkat substansial yang tinggi, kreativitas, dan utilitas.',
    '➱ Kami sepenuhnya terlibat dalam menyelesaikan masalah klien kami, memenuhi kebutuhan dan harapan mereka.',
    '➱ Kami menerapkan standar etika bisnis tertinggi.',
];

export const WHY_US = 'Mengapa kami?';
export const OUR_SOURCES = 'Sumber keunggulan kompetitif kami - apa yang membedakan kami dari perusahaan konsultasi lainnya';
export const POSITION = 'Kami membangun posisi kompetitif kami di pasar layanan konsultasi Polandia dengan penekanan khusus pada kompetensi yang terus berkembang berikut:';
export const POSITION_LIST = [
    '➱ Kami menciptakan tim ahli dengan kualifikasi tinggi yang terus mengembangkan kompetensi mereka (selain pengalaman profesional yang kaya, karyawan kami memiliki gelar doktor dalam ekonomi, diploma MBA dari universitas Amerika dan Polandia, serta banyak sertifikat dan kursus yang diselesaikan)',
    '➱ Kami sangat mengenal spesifikasi perusahaan Polandia, serta masalah menjalankan bisnis dalam kondisi restrukturisasi dan reorganisasi (selain banyak proyek konsultasi yang diselesaikan, ini dikonfirmasi oleh banyak publikasi di pers Polandia)',
    '➱ Pengalaman bertahun-tahun kami dalam merancang dan merasionalisasi organisasi dan manajemen, serta pengetahuan tentang spesifikasi perusahaan di banyak industri, unit penelitian, dan pemerintah daerah, telah berkontribusi pada pengembangan basis data solusi organisasi yang unik (mungkin satu-satunya di negara ini)',
    '➱ Kami memiliki alat khusus untuk berbagai jenis organisasi, termasuk perusahaan industri yang beroperasi secara terus-menerus, perusahaan logistik, unit pemerintah daerah, kantor teknik, dan institut penelitian dan pengembangan',
    '➱ Ciri khas kami adalah fleksibilitas luar biasa dalam menyelesaikan masalah klien (dari manajemen sementara dan outsourcing fungsi manajemen yang dipilih hingga konsultasi partisipatif melalui partisipasi dalam tim tugas yang terdiri dari karyawan klien)',
    '➱ Menawarkan kualitas layanan dan reputasi merek pada tingkat perusahaan konsultasi internasional terbesar, kami menyediakan layanan dengan harga lebih rendah',
];

export const OUR_FEATURES = 'Akibatnya, menurut pendapat klien kami (berdasarkan pendapat yang paling sering diulang dari surat referensi), pekerjaan kami ditandai oleh:';
...
export const EU_PROJECTS_DESC = 'Kami dengan senang hati menginformasikan tentang proyek baru yang sedang diimplementasikan oleh Institut Organisasi INORG Sp. z o.o. di bawah Program Operasi Pengembangan Cerdas 2014-2020, khususnya Sub-ukuran 2.3.5 - Desain untuk Perusahaan. Proyek kami, yang berjudul "Diversifikasi kegiatan INORG melalui desain dan implementasi perangkat lunak inovatif yang mendukung sistem manajemen sesuai dengan standar ISO9001", dianugerahi nomor aplikasi POIR.02.03.05-24-0019/18. Tujuan dari inisiatif kami adalah untuk menciptakan dan membawa ke pasar produk unik - alat TI modern yang akan memungkinkan implementasi, administrasi, dan pengembangan sistem manajemen yang bersertifikat sesuai dengan standar internasional ISO9001. Berkat proyek ini, perusahaan kami tidak hanya akan mendiversifikasi kegiatannya, tetapi juga secara signifikan meningkatkan pendapatan dan keuntungannya, membangun keunggulan kompetitif yang langgeng di pasar konsultasi.';
